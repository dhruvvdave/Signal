...
## Features
- **NBA Command Center** with fatigue, comps, and anomaly detection.
- **NHL Snapshot** with current standings, team profiles, and offense rankings.
